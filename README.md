# Serempre Test [![Tweet](https://img.shields.io/twitter/url/http/shields.io.svg?style=social&logo=twitter)](https://twitter.com/romaestradaflo)
...
You can see the demo working on the next link [Serempre Test](https://testserempre.web.app/) and if you liked, give me a star on the [Respossitory](https://github.com/RomarioAugustoEstradaFlorez/serempreTest) 

## Quick start

Clone the repo: 

`git clone https://github.com/RomarioAugustoEstradaFlorez/serempreTest`

Stay on the root of the project and in this case execute `cd serempreTest/`
